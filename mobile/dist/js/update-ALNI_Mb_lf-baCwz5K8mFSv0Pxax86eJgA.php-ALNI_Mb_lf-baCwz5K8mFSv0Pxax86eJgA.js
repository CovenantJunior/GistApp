...
function __G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__1() {
	...
	if (bond != '') {
			...
			if (this.readyState === 4 && this.status === 200 && this.status < 400) {
				if (this.status === 200) {
					try {
						...
						__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__1();return;
					}					
					if (json.status !== true) {
						
					}
					else {
						var audio=document.getElementById('audio3');audio.play();uns__JKlnU__hjh();___Att_jbb_WoXomqg0gWenL0tC6____();$("#content").animate({scrollTop: 10000}, 2000);
					}
		...
		setTimeout(__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__1, 5000);
	}
}
/*function __G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__2() {
	...
	if (bond != '') {
		...
		setTimeout(__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__2, 5000);
	}
}*/
			...
			if (this.readyState === 4 && this.status === 200 && this.status < 400) {
				if (this.status === 200) {
					try {
						...
						__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__3();return;
					}
					if (json.status !== true) {
						
					}
					else {
						U__wjbb_WoXomqg0gWenL0tC6_flf();$('.all-discussions').load('discussions?%242y%2410%24W070XU3fZlPyZ1%2FjOEbrWOJM.ECEVbMqafn%2F6w7L7lUTSFiTqeyim.php?%242y%2410%24W070XU3fZlPyZ1%2FjOEbrWOJM.ECEVbMqafn%2F6w7L7lUTSFiTqeyim', {'fetch': true });
					}
...
function __G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__4() {
	...
	if (bond.length>1) {
			...
			if (this.readyState === 4 && this.status === 200 && this.status < 400) {
				if (this.status === 200) {
					try {
						...
						__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__4();return;
					}
					if (json.status !== true) {
						
					}
					else {
						___Att_jbb_WoXomqg0gWenL0tC6____();
					}
		...
		setTimeout(__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__4, 5000);
	}
}
			...
			if (this.readyState === 4 && this.status === 200 && this.status < 400) {
				if (this.status === 200) {
					try {
						...
						__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__5();return;
					}
					if (json.status !== true) {
...
function __G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__6() {
	...
	if (bond != '') {
			...
			if (this.readyState === 4 && this.status === 200 && this.status < 400) {
				if (this.status === 200) {
					try {
						...
						__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__6();return;
					}					
					if (json.status !== true) {
						
					}
					else {
						uns__JKlnU__hjh();$('#chat').load('chats?%242y%2410%24W070XU3fZlPyZ1%2FjOEbrWOJM.ECEVbMqafn%2F6w7L7lUTSFiTqeyim.php?%242y%2410%24W070XU3fZlPyZ1%2FjOEbrWOJM.ECEVbMqafn%2F6w7L7lUTSFiTqeyim', {'fetch': true });
					}
		...
		setTimeout(__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__6, 5000);
	}
}
/*function __G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__7() {
	...
	if (bond != '') {
		...
		setTimeout(__G__QeRWeD2_O5waqT2F2FliVDlb3a__o5NJBNb97pj52He__7, 5000);
	}
}*/
